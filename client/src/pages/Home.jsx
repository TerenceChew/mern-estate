...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const fetchListingsWithOffer = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_SERVER_BASE_URL}/api/listing/search?offer=true&limit=4`);
    ...
    const fetchListingsForRent = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_SERVER_BASE_URL}/api/listing/search?type=rent&limit=4`);
        const data = await res.json();
    ...
    const fetchListingsForSale = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_SERVER_BASE_URL}/api/listing/search?type=sale&limit=4`);
        const data = await res.json();
